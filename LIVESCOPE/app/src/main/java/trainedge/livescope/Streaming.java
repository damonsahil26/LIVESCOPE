...
public class Streaming extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        goCoder = WowzaGoCoder.init(getApplicationContext(), "GOSK-9743-0103-7F91-9246-1ACA");
        ...
        goCoderBroadcastConfig.setHostAddress("https://cloud.wowza.com/en/wxpq9jsb/manage/live_streams/rkbpv4kn");
        goCoderBroadcastConfig.setPortNumber(1935);
        goCoderBroadcastConfig.setApplicationName("LiveScope");
        goCoderBroadcastConfig.setStreamName("11bd96c9");
    ...
    public void onWZStatus(final WZStatus goCoderStatus) {
        ...
        new Handler(Looper.getMainLooper()).post(new Runnable() {
            @Override
            public void run() {
                Toast.makeText(Streaming.this, statusMessage, Toast.LENGTH_LONG).show();
            }
        });
    }
